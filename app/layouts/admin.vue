<template>
  <div class="flex min-h-screen bg-gray-50">
    ...
    <main class="flex-1 flex flex-col">
      ...
      <!-- Page Content -->
      <div class="flex-1 overflow-auto p-6 pb-10">
        <slot />
      </div>
    </main>
  </div>
...
const menu = [
  { label: 'Home', icon: 'i-heroicons-home', to: '/dashboard/admin' },
  { label: 'Dokumen', icon: 'i-heroicons-document-text', to: '/dashboard/admin/dokumen' },
  { label: 'Iuran', icon: 'i-heroicons-banknotes', to: '/dashboard/admin/iuran' }
]
