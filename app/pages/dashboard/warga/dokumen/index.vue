<template>
  <div class="p-4 space-y-4">
   ...
   <!-- Pagination -->
      <UPagination v-if="dukumen?.pagination?.total > itemsPerPage" v-model:page="currentPage" :items-per-page="itemsPerPage" :total="totalItems" />
...
const { data: dukumen, pending, refresh } = await request('api/v1/posts/dokumen', {
  headers: {
...
// Pagination calculations
 const totalPages = computed(() => dukumen?.value?.pagination?.total_pages)
 const totalItems = computed(() => dukumen?.value?.pagination?.total)
